                        ...
                        <div>
                            ...
                            <div class="job-opening-light">
                                ...
                                <ul class="list-icons">
                                    ...
                                    <li class="object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="100"><i class="icon-check"></i> Sound knowledge of Node using ExpressJS or NestJs </li>
