            ...
            <footer id="footer">
                                ...
                                <div class="footer-content">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            ...
                                            <p class="width-70">Lorem ipsum dolor sit amet, consect tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim ven.</p>
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <h2 class="margin-bottom-10">Sales Office</h2>
                                            <ul class="list-icons">
                ...
                <div class="subfooter">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <p>Copyright © 2020 Utkal Labs Pvt. Ltd. All Rights Reserved</p>
                            </div>
                            <div class="col-md-6">
